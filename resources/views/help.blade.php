      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="item active">
            <img src="{{ asset('images/carpinteria.png') }}" class="img-responsive" alt="Carpinteria1" width="100%" height="100%">
          ...
          <div class="item">
            <img src="{{ asset('images/carpinteria-1.png') }} " alt="Carpinteria2" width="100%" height="1000%">
            <div class="carousel-caption">
              <h1 class="textoayuda">
...
<div class="container">
      <ul class="nav nav-pills nav-justified">
        <li class="active servicios"><a data-toggle="pill" href="#home">Lo más consultado</a></li>
        <li class="servicios"><a data-toggle="pill" href="#menu1">Págos</a></li>
        <li class="servicios"><a data-toggle="pill" href="#menu2">Servicios</a></li>
        <li class="servicios"><a data-toggle="pill" href="#menu3">Subscripción</a></li>
      </ul>
...
<!--Inicio Preguntas Frecuentes-->
         <h3 class="iconcenter">
        <span class="glyphicon glyphicon-globe iconos"><br><p class="iconos">Más Consultados</p></span>
      </h3>

        <h2 class="textfaq categorias">
            Preguntas frecuentes (FAQ)
        </h2>
        <p class="servicios"><strong>Nota:</strong> Las <strong>respuestas</strong> de las siguientes preguntas lograrás visualizarlas al hacer <strong>Clik </strong>en los Items siguientes.</p>
...
<!--Fin Preguntas Frecuentes-->
    ...
    <div id="menu1" class="tab-pane fade">
          <h3 class="iconcenter">
        <span class="glyphicon glyphicon-usd iconos"><br><p class="iconos">Págos</p></span>
          </h3>

          <!-- Pregunta 04-->
          <h2 class="textfaq categorias">Preguntas frecuentes (FAQ)</h2>
          <p class="servicios"><strong>Nota:</strong> Las <strong>respuestas</strong> de las siguientes preguntas lograrás visualizarlas al hacer <strong>Clik </strong>en los Items siguientes.</p>
          <div class="panel panel-default">
            <div class="panel-heading">
              <h4 class="panel-title">
    ...
    <div id="menu2" class="tab-pane fade">
          <!-- Pregunta 06-->
          <h3 class="iconcenter">
        <span class="glyphicon glyphicon-wrench iconos"><br><p class="iconos">Servicios</p></span>
      </h3>
    ...
    <div id="menu3" class="tab-pane fade">
          <!-- Pregunta 08-->
          <h3 class="iconcenter">
        <span class="glyphicon glyphicon-book iconos"><br><p class="iconos">Suscripción</p></span>
      </h3>
